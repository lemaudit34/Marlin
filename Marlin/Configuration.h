...
#define STRING_CONFIG_H_AUTHOR "(V2.1.6, Havez config)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Custom U20"
#define CONFIGURABLE_MACHINE_NAME // Add G-code M550 to set/report the machine name

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "d7c94ac1-256d-489a-a0c9-51c0652d4c2a"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP  143.23
  #define DEFAULT_BED_KI   27.51
  #define DEFAULT_BED_KD 497.04
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30.5, -42.1, -5.3 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define PREHEAT_BEFORE_PROBING
  ...
  #define PROBING_NOZZLE_TEMP 15   // (°C) Only applies to E0 at this time
