...
#define STRING_CONFIG_H_AUTHOR "(V2.1.3, Havez config)" // Who made the changes.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 143.23
  #define DEFAULT_bedKi 27.51
  #define DEFAULT_bedKd 497.04
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 78.99, 79.72, 399.6, 95 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, -22, -1.38 }
